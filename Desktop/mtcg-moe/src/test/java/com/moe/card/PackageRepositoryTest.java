...
public class PackageRepositoryTest {
    ...
    void testGetPackage() {
        try {
            ...
            // act
            Package cardPackage = (Package) packageRepository.getPackage(-1);
    ...
    void testAddPackage() {
        try {
            ...
            // act
            Package cardPackage = (Package) packageRepository.addPackage(newCardPackage);
    ...
    void testDeletePackage() {
        try {
            ...
            // act
            boolean result = packageRepository.deletePackage(-1);
